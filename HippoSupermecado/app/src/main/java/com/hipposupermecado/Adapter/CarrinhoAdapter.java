...
public class CarrinhoAdapter extends BaseAdapter {
    ...
    private List<Carrinho> listaProduto;

    public CarrinhoAdapter(Context mContext, List<Carrinho> listaProduto) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = View.inflate(mContext, R.layout.item_carrinho, null);
        ...
        tvQtdProdutos.setText(Integer.toString(listaProduto.get(position).getQtd()));
